          ...
          >
            ...
            <div className="mb-4">
              ...
              <input
                ...
                required
                className="block border-gray-300 focus:border-green-500 shadow-sm mt-1 px-3 py-2 border rounded-md focus:ring-green-500 w-full text-gray-900 sm:text-sm focus:outline-none"
              />
            </div>
